      ...
      <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
        <ul class="pb-2 space-y-2">
          ...
          {{-- <li>
            ...
            <ul id="dropdown-layouts" class="py-2 space-y-2 {{ Request::is('layouts/*') ? 'block' : 'hidden' }}">
              <li>
                <a href="{{ url('example/layouts/stacked') }}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700
                  {{ Request::is('example/layouts/stacked') ? 'bg-gray-200 dark:bg-gray-700' : '' }}">
                  Stacked
                </a>
              </li>
              <li>
                <a href="{{ url('example/layouts/sidebar') }}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700
                  {{ Request::is('example/layouts/sidebar/*') ? 'bg-gray-200 dark:bg-gray-700' : '' }}">
                  Sidebar
                </a>
              </li>
            </ul>
          ...
          <li>
            <a href="{{ url('user/') }}" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 {{ $page_slug == 'settings' ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
            <svg class="w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" d="M10 2a5 5 0 00-5 5 5 5 0 0010 0 5 5 0 00-5-5zm0 12a7 7 0 00-7 7h14a7 7 0 00-7-7z" clip-rule="evenodd"></path>
                </svg>
          ...
          <li>
            <button type="button" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
              ...
              <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 16">
            ...
            <ul id="dropdown-crud" class="space-y-2 py-2 {{ Request::is('crud/*') ? 'block' : 'hidden' }}">
              <li>
                <a href="{{ url('/product') }}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700
                  {{ Request::is('crud/products') ? 'bg-gray-200 dark:bg-gray-700' : '' }}">
                  Produk
                </a>
              </li>
              @if(auth()->user()->role === 'Admin')
          ...
          @if(Auth::check() && (Auth::user()->role == 'Admin' || Auth::user()->role == 'Manajer Gudang'))
          <li>
            <a href="{{ url('supplier/') }}" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 {{ $page_slug == 'settings' ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
            <svg class="w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path d="M3 3a1 1 0 00-1 1v12a1 1 0 001 1h14a1 1 0 001-1V4a1 1 0 00-1-1H3zm0 2h14v10H3V5z"></path>
                </svg>
          ...
          <li>
            ...
            <ul id="dropdown-stock" class="space-y-2 py-2 {{ Request::is('stock/*') ? 'block' : 'hidden' }}">
              <li>
                <a href="{{ url('/stock/transaction/masuk') }}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700
                  {{ Request::is('stock/transaction') ? 'bg-gray-200 dark:bg-gray-700' : '' }}">
                  Transaksi Masuk
                </a>
              </li>
              <li>
                <a href="{{ url('/stock/transaction/keluar') }}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700
                  {{ Request::is('stock/transaction') ? 'bg-gray-200 dark:bg-gray-700' : '' }}">
                  Transaksi Keluar
                </a>
              </li>
              @if(Auth::check() && (Auth::user()->role == 'Admin' || Auth::user()->role == 'Manajer Gudang'))
              <li>
                <a href="{{ url('/stock/opname') }}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700
                  {{ Request::is('stock/transaction') ? 'bg-gray-200 dark:bg-gray-700' : '' }}">
                  Stock Opname
                </a>
              </li>
        ...
        <li>
          <button type="button" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
            ...
            <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
              <path fill-rule="evenodd" d="M2 3a1 1 0 011-1h14a1 1 0 011 1v12a1 1 0 01-1 1h-4.5v1H15a1 1 0 010 2H5a1 1 0 010-2h2.5v-1H3a1 1 0 01-1-1V3zm2 1h12v10H4V4zm4 2a1 1 0 100 2h2a1 1 0 100-2H8zm0 4a1 1 0 100 2h4a1 1 0 100-2H8z" clip-rule="evenodd"></path>
            </svg>
          ...
          <ul id="dropdown-laporan" class="space-y-2 py-2 {{ Request::is('crud/*') ? 'block' : 'hidden' }}">
            <li>
              <a href="{{ url('/laporan/transaction/masuk') }}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700
                {{ Request::is('laporan/transactionmasuk') ? 'bg-gray-200 dark:bg-gray-700' : '' }}">
                Transaksi Masuk
              </a>
            </li>
            <li>
              <a href="{{ url('/laporan/transaction/keluar') }}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700
                {{ Request::is('laporan/transactionkeluar') ? 'bg-gray-200 dark:bg-gray-700' : '' }}">
                Transaksi Keluar
              </a>
            </li>
            <li>
            ...
            @if(auth()->user()->role === 'Admin')
            <li>
              <a href="{{ url('/laporan/activity') }}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700
                {{ Request::is('laporan/user') ? 'bg-gray-200 dark:bg-gray-700' : '' }}">
                Aktivitas Pengguna
              </a>
            </li>
            @endif
        ...
        @endif
          @if(auth()->user()->role === 'Admin')
          <li>
            <a href="{{ url('/settings') }}" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 {{ $page_slug == 'settings' ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
          ...
          {{-- <li>
            ...
            <ul id="dropdown-pages" class="hidden py-2 space-y-2">
              <li>
                <a href="{{ url('example/pages/pricing/') }}" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Pricing</a>
              </li>
              <li>
                <a href="{{ url('example/pages/maintenance/') }}" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Maintenance</a>
              </li>
              <li>
                <a href="{{ url('example/pages/404/') }}" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">404 not found</a>
              </li>
              <li>
                <a href="{{ url('example/pages/500/') }}" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">500 server error</a>
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul id="dropdown-auth" class="hidden py-2 space-y-2">
              <li>
                <a href="{{ url('example/authentication/sign-in') }}" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Sign in</a>
            </li>
            <li>
                <a href="{{ url('example/authentication/sign-up') }}" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Sign up</a>
            </li>
            <li>
                <a href="{{ url('example/authentication/forgot-password') }}" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Forgot password</a>
            </li>
            <li>
                <a href="{{ url('example/authentication/reset-password') }}" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Reset password</a>
            </li>
            <li>
                <a href="{{ url('example/authentication/profile-lock') }}" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Profile lock</a>
            </li>
            </ul>
          </li> --}}
