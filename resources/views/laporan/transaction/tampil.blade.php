                ...
                <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                  ...
                  <li>
                    <div class="flex items-center">
                      ...
                      <a href="{{ route('laporan.transaction.tampil', ['type' => strtolower($transactions->first()->type)]) }}" class="ml-1 text-gray-700 hover:text-primary-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">Laporan Transaksi {{ $transactions->first()->type }}</a>
                    </div>
                  </li>
                  <li>
                    <div class="flex items-center">
