...
<script>
    function setModalData(appName, logo) {
        document.getElementById('modal-app-name').value = appName;
        document.getElementById('modal-logo').src = logo;
        openModal(); // Pastikan modal terbuka
    }
</script>
<div class="grid grid-cols-1 px-4 pt-6 xl:grid-cols-3 xl:gap-4 dark:bg-gray-900">
    ...
    <!-- Right Content -->
    <div class="col-span-full pt-9">
            <div class="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                <div class="items-center sm:flex xl:block 2xl:flex sm:space-x-4 xl:space-x-0 2xl:space-x-4">
                    <img class="mb-4 rounded-lg w-28 h-28 sm:mb-0 xl:mb-4 2xl:mb-0 logo" src="{{ asset('storage/' . $settings->logo) }}" alt="logo">
                    <div>
                        <h3 class="mb-1 text-xl font-bold text-gray-900 dark:text-white app_name">{{ $settings->app_name }}</h3>
                        <div class="mb-4 text-sm text-gray-500 dark:text-gray-400">
                            Ini adalah aplikasi pengelolaan stock.
                        </div>
                        <div class="flex items-center space-x-4">
                            <button type="button" data-modal-target="change-modal" data-modal-toggle="change-modal" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800" onclick="setModalData('{{ $settings->app_name }}', '{{ asset('storage/' . $settings->logo) }}')">
                ...
                <ul class="mb-6 divide-y divide-gray-200 dark:divide-gray-700">
                    <li class="py-4">
                        <div class="flex justify-between xl:block 2xl:flex align-center 2xl:space-x-4">
                            <div class="flex space-x-4 xl:mb-4 2xl:mb-0">
                                <div>
                                    <img class="w-6 h-6 rounded-full" src="{{ asset('static/images/users/bonnie-green.png') }}" alt="Bonnie image">
                                </div>
                                <div class="flex-1 min-w-0">
                    ...
                    <li class="py-4">
                        <div class="flex justify-between xl:block 2xl:flex align-center 2xl:space-x-4">
                            <div class="flex space-x-4 xl:mb-4 2xl:mb-0">
                                <div>
                                    <img class="w-6 h-6 rounded-full" src="{{ asset('static/images/users/jese-leos.png') }}" alt="Jese image">
                                </div>
                                <div class="flex-1 min-w-0">
                                    <p class="text-base font-semibold text-gray-900 leading-none truncate mb-0.5 dark:text-white">
                                        Jese Leos
                    ...
                    <li class="py-4">
                        <div class="flex justify-between xl:block 2xl:flex align-center 2xl:space-x-4">
                            <div class="flex space-x-4 xl:mb-4 2xl:mb-0">
                                <div>
                                    <img class="w-6 h-6 rounded-full" src="{{ asset('static/images/users/thomas-lean.png') }}" alt="Thomas image">
                                </div>
                                <div class="flex-1 min-w-0">
                                    <p class="text-base font-semibold text-gray-900 leading-none truncate mb-0.5 dark:text-white">
                                        Thomas Lean
                    ...
                    <li class="pt-4">
                        <div class="flex justify-between xl:block 2xl:flex align-center 2xl:space-x-4">
                            <div class="flex space-x-4 xl:mb-4 2xl:mb-0">
                                <div>
                                    <img class="w-6 h-6 rounded-full" src="{{ asset('static/images/users/lana-byrd.png') }}" alt="Lana image">
                                </div>
                                <div class="flex-1 min-w-0">
                                    <p class="text-base font-semibold text-gray-900 leading-none truncate mb-0.5 dark:text-white">
                                        Lana Byrd
