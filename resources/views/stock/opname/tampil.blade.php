                ...
                <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                  ...
                  <li>
                    <div class="flex items-center">
                      ...
                      <a href="{{ route('stock.opname.tampil') }}" class="ml-1 text-gray-700 hover:text-primary-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">Stock Opname</a>
                    </div>
                  </li>
                  <li>
                    <div class="flex items-center">
            ...
            <div class="overflow-hidden shadow">
                <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700" data-opname-id={{ $opname['id'] }} >
                            <td class="w-4 p-4">
                                <div class="flex items-center">
                            ...
                            <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white product-sku"> {{ $opname->product->sku}} </td>
                            <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white product-stock"> {{ $opname->category->name}} </td>
                            <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white product-stock"> {{ $opname->product->name}} </td>
                            <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400 product-stock"> {{ $opname['stock_akhir']}} </td>
...
{{-- @include('stock.opname.tambah')

@include('stock.opname.delete') --}}
